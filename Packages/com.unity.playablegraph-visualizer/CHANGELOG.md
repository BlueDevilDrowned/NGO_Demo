...
- Fixed compilation against Unity 6, where `PlayableGraph.Null` is not available.
- Made graph selection resilient to graphs being created or destroyed while the window is open.
- Fixed layout and rendering edge cases for single-node graphs and very small windows.
